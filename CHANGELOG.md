...
- “数字与格式（ITN）”新增“中文与英文/数字间空格”开关。开启后在相邻中文与 ASCII 英文或数字之间添加空格，默认关闭。
...
- Allow `Shift+Space` in Settings validation, matching the Fcitx5 module and preventing an existing user binding from being reset to `Shift+F9` when unrelated settings are saved.

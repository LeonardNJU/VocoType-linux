...
"$ROOT/src/workers/funasr/build.sh" >/tmp/vocotype-native-worker-path.txt
bundle="$ROOT/src/workers/funasr/build/bundle"
rm -f "$bundle/bin/vocotype-core"
"$ROOT/src/workers/funasr/audit_bundle.sh" "$bundle"
for required in \
